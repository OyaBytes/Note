<script lang="ts">
  ...
  <div class="flex rounded-md" use:melt={$menubar}>
    <!------------>
    <!--- FILE --->
    <!------------>
    <button
  ...
  <style lang="postcss">
    .menu {
      ...
      @apply rounded-md p-1 lg:max-h-none bg-white;
      @apply ring-0 !important;
    }
    .subMenu {
      @apply min-w-[220px] bg-white shadow-md shadow-neutral-900/30;
    }
    .item {
      @apply relative h-6 min-h-[24px] select-none rounded-sm pl-6 pr-1;
      @apply z-20 text-gray-800 outline-none;
      @apply data-[highlighted]:bg-gray-200 data-[highlighted]:text-gray-800;
    ...
    .trigger {
      ...
      @apply text-gray-800 transition-colors hover:bg-white/90 data-[highlighted]:outline-none;
      @apply overflow-visible data-[highlighted]:bg-gray-200 data-[highlighted]:ring-gray-400 !important;
      @apply !cursor-default text-lg leading-none focus:z-30 focus:ring;
    }
    .check {
    ...
    .dot {
      @apply h-[4.75px] w-[4.75px] rounded-full bg-gray-800;
    }
  
    .separator {
      @apply m-[5px] h-[1px] bg-gray-200;
    }
