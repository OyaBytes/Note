...
<div class="color-picker-inner">
	<button bind:clientHeight={inputHeight} class="select-color" on:click={(e) => toggleDropdown(e)} class:fake-focus={ddActive}>
		<div style="display: flex;">
			<div style="background: {value};" class="color-block-picker"></div>
...
{#if ddActive}
<div class:top={top} bind:clientHeight={ddHeight} transition:slide class="values-dropdown" use:clickOutside on:click_outside={clickOutsideDropdown}>
